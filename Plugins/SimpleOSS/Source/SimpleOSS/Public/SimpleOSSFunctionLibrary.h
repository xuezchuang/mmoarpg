...
public:
	...
	*/
	UFUNCTION(BlueprintPure, Category = "SimpleOSS|Get")
	static bool GetObjectToMemoryByURL(const FString& URL, FString &ContextString, FRange Range);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SimpleOSS|Put")
	static bool PutObjectByMemory(const FString &InBucketName, const FString &InObjectName, const FString &Data, const TMap<FString, FString> &OSSMeta);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SimpleOSS|Put")
	static bool PutObjectMemoryByURL(const FString& URL, const FString &Data, const TMap<FString, FString> &OSSMeta);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SimpleOSS|Put|Async")
	static void AsyncPutObjectByMemory(const FString &InBucketName, const FString &InObjectName, const FString &Data, FProgressCallbackDelegate InProgressCallback , const TMap<FString, FString> &OSSMeta);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SimpleOSS|Put|Async")
	static void AsyncPutObjectMemoryByURL(const FString& URL, const FString &Data, FProgressCallbackDelegate InProgressCallback,const TMap<FString, FString> &OSSMeta);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SimpleOSS|Get|Async")
	static void AsyncGetObjectToMemory(const FString &InBucketName, const FString &InObjectName, FRange Range, FProgressCallbackDelegate InProgressCallback, FBufferByOSSCallbackDelegate InStartCallback,FBufferByOSSCallbackDelegate InEndCallback);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SimpleOSS|Get|Async")
	static void AsyncGetObjectToMemoryByURL(const FString& URL, FRange Range , FProgressCallbackDelegate InProgressCallback, FBufferByOSSCallbackDelegate InStartCallback, FBufferByOSSCallbackDelegate InEndCallback);
