...
TSharedPtr< FSlateStyleSet > FSimpleNumericalDeductionStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FSimpleNumericalDeductionStyle::Create()
{
	...
	Style->Set("SimpleNumericalDeduction.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
