...
#pragma region GetObjects
		...
		* @InObjectName	Object
		*/
		bool GeneratePresignedUrl(FString &URL,const FString &InBucketName, const FString &InObjectName);
		...
		*/
		bool GetObjectToMemory(const FString &InBucketName, const FString &InObjectName, FString &ContextString, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr ,OnceStringCallBack StartCallback = nullptr, OnceStringCallBack EndCallback = nullptr);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		bool GetObjectToMemoryByURL(const FString& URL, FString &ContextString, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack StartCallback = nullptr, OnceStringCallBack EndCallback = nullptr);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		bool GetObjectToLocalByURL(const FString& URL, const FString& InLocalPaths, FRange Range = FRange(),ProgressCallback InProgressCallback = nullptr, OnceStringCallBack InStartCallback = NULL, OnceStringCallBack InEndCallback = NULL);
...
#pragma region Async
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		void AsyncPutObjectByURL(const FString& URL, const FString& InLocalPaths, const TMap<FString, FString> &OSSMeta =TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		void AsyncPutObjectByMemory(const FString &InBucketName, const FString &InObjectName, const FString &Data, ProgressCallback InProgressCallback = nullptr, const TMap<FString, FString> &OSSMeta = TMap<FString, FString>());
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		void AsyncPutObjectMemoryByURL(const FString& URL, const FString &Data, const TMap<FString, FString> &OSSMeta = TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		void AsyncGetObjectToLocalByURL(const FString& URL, const FString& InLocalPaths, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack InStartCallback = NULL, OnceStringCallBack InEndCallback = NULL);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		void AsyncGetObjectToMemory(const FString &InBucketName, const FString &InObjectName, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack InStartCallback = NULL, OnceStringCallBack InEndCallback = NULL);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		void AsyncGetObjectToMemoryByURL(const FString& URL,FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack InStartCallback = NULL, OnceStringCallBack InEndCallback = NULL);
...
#pragma region PutObject
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectByURL(const FString& URL, const FString& InLocalPaths, const TMap<FString, FString> &OSSMeta = TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectByMemory(const FString &InBucketName,const FString &InObjectName , const FString &Data, ProgressCallback InProgressCallback = nullptr, const TMap<FString, FString> &OSSMeta = TMap<FString, FString>());
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectMemoryByURL(const FString& URL, const FString &Data, const TMap<FString, FString> &OSSMeta = TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
